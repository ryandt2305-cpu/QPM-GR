...
export type MutationName = 'Gold' | 'Rainbow' | 'Wet' | 'Chilled' | 'Frozen' | 'Dawnlit' | 'Ambershine' | 'Dawncharged' | 'Ambercharged' | 'Dawnbound' | 'Amberlit' | 'Amberbound';
...
export interface SpriteState {
    ...
    jobs: RenderJob[];
    jobMap: Set<string>;
    srcCan: Map<any, HTMLCanvasElement>;
    atlasBases: Set<any>;
...
export interface SpriteService {
    ...
    getBaseSprite(params: GetSpriteParams): any;
    getSpriteWithMutations(params: GetSpriteParams): any;
    ...
    renderOnCanvas(arg: GetSpriteParams | any, opts?: RenderOptions): {
        wrap: HTMLDivElement;
