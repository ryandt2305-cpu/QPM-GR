 ...
 */
export declare function calculateLiveETA(lastProcAt: number | null, expectedMinutesBetween: number | null, effectiveProcsPerHour?: number): {
    text: string;
    isOverdue: boolean;
};
/**
 ...
 */
export declare function createAbilityRow(entry: AbilityContribution, abilityName: string, tbody: HTMLTableSectionElement, detailedView?: boolean): HTMLTableRowElement;
/**
 * Create a total row for an ability group (showing combined stats for multiple pets with same ability)
 */
export declare function createAbilityGroupTotalRow(group: AbilityGroup, tbody: HTMLTableSectionElement, detailedView?: boolean): HTMLTableRowElement | null;
