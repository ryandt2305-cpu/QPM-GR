...
export function ensureAlertStyles(): void {
  ...
  style.textContent = [
    ...
    '.qpm-restock-alert__icon-shell{width:34px;height:34px;border-radius:8px;border:1px solid rgba(229,231,235,0.16);background:rgba(255,255,255,0.05);display:flex;align-items:center;justify-content:center;flex-shrink:0;overflow:hidden;}',
    '.qpm-restock-alert__icon{width:26px;height:26px;object-fit:contain;image-rendering:pixelated;display:none;}',
    ...
    '.qpm-restock-alert__item{font-size:14px;font-weight:700;color:#e9e7ff;line-height:1.25;white-space:nowrap;overflow:hidden;text-overflow:ellipsis;}',
    '.qpm-restock-alert__qty-row{display:flex;justify-content:space-between;align-items:center;gap:8px;}',
    '.qpm-restock-alert__qty{font-size:12px;color:rgba(229,231,235,0.8);}',
    '.qpm-restock-alert__status{font-size:11px;color:rgba(200,192,255,0.72);white-space:nowrap;flex-shrink:0;}',
