...
import { getWeatherSnapshot, onWeatherSnapshot, type WeatherSnapshot } from '../utils/weatherInfo';
import { type DetailedWeather } from '../utils/weatherInfo';
...
export function startMutationTracker(): void {
  ...
  // Weather info initialized automatically
  latestWeatherSnapshot = getWeatherSnapshot();
  if (latestWeatherSnapshot) currentWeather = mapDetailedWeather(latestWeatherSnapshot.kind);
