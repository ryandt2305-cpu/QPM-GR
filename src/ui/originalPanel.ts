...
async function createAutoFavoriteSection(): Promise<HTMLElement> {
  ...
  const mutationOptions = [
    ...
    { id: 'Dawncharged', label: 'Dawncharged', color: '#FF5722' },
    { id: 'Ambershine', label: 'Ambershine', color: '#FFC107' },
    { id: 'Ambercharged', label: 'Ambercharged', color: '#FF6F00' },
  ];
  ...
  mutationOptions.forEach(option => {
    ...
    spriteEl.dataset.qpmSprite = `crop:Sunflower:${option.id}`;
